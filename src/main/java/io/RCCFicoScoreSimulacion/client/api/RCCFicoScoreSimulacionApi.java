...
import io.RCCFicoScoreSimulacion.client.ApiResponse;
import io.RCCFicoScoreSimulacion.client.Configuration;
import io.RCCFicoScoreSimulacion.client.Pair;
import io.RCCFicoScoreSimulacion.client.ProgressRequestBody;
import io.RCCFicoScoreSimulacion.client.ProgressResponseBody;
...
public class RCCFicoScoreSimulacionApi {
    private ApiClient apiClient;
    public RCCFicoScoreSimulacionApi() {
        this(Configuration.getDefaultApiClient());
    }
    public RCCFicoScoreSimulacionApi(ApiClient apiClient) {
